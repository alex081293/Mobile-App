...
import com.example.zephyrbioharness.R;
        	...
        	btnConnect.setOnClickListener(new OnClickListener() {
        		public void onClick(View v) {
        			...
        			tv1.setText("000");
        			 ...
        			 /*tv1 = 	(TextView)findViewById(R.id.txtSkinTemp);
        			 tv1.setText("0.0");
        			 
        			 tv1 = 	(TextView)findViewById(R.id.txtPosture);
        			 tv1.setText("000");
        			 
        			 tv1 = 	(TextView)findViewById(R.id.txtPeakAcc);
        			 tv1.setText("0.0"); */
    ...
    final  Handler Newhandler = new Handler() {
    	public void handleMessage(Message msg) {
    		...
    		/*case SKIN_TEMPERATURE:
    			...
    			tv = (TextView)findViewById(R.id.txtSkinTemp);
    		...
    		case PEAK_ACCLERATION:
    			...
    			tv = (TextView)findViewById(R.id.txtPeakAcc);
